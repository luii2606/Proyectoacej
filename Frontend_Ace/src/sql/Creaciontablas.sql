...
-- Tabla de tipo de rol
 DROP TABLE IF EXISTS roles; 
CREATE TABLE roles ( 
id INT PRIMARY KEY auto_increment, 
nombre VARCHAR(50) NOT NULL -- (manicurista, estilista, cosmetologo, todo)
 );
...
descripcion TEXT, 
precio DECIMAL(10,2), 
id_roles int, foreign key (id_roles) references roles(id) ); 
...
-- Tabla de orden de servicios (tabla que guarda los datos de la agenda) 
...
nombre varchar (100)
 ...
 -- Luego creamos la nueva versión de la tabla con la relación a tipo_usuario 
CREATE TABLE permisos_tipo_usuario ( 
id INT PRIMARY KEY auto_increment, 
id_permisos INT, 
id_tipo_usuario INT,
 -- Ahora relacionado con tipo_usuario en lugar de tipo_rol 
...
-- permite agregar productos opcionales a una orden 
...
id INT PRIMARY KEY AUTO_INCREMENT,
 id_orden INT NOT NULL, fecha_emision DATETIME DEFAULT CURRENT_TIMESTAMP, 
